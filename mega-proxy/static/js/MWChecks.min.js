...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].oneOf[1].use[2]!./node_modules/vue-select/dist/vue-select.css":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].oneOf[1].use[2]!./node_modules/vue-select/dist/vue-select.css ***!
  \***************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_5_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_oneOf_1_use_2_vue_select_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??ruleSet[1].rules[5].oneOf[1].use[1]!../../postcss-loader/dist/cjs.js??ruleSet[1].rules[5].oneOf[1].use[2]!./vue-select.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].oneOf[1].use[2]!./node_modules/vue-select/dist/vue-select.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_5_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_oneOf_1_use_2_vue_select_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_5_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_oneOf_1_use_2_vue_select_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
var app = new Vue({
  ...
  methods: {
    copyConf: function copyConf(index) {
      this.copy = this.report.configuration[index].commands;
    },
    pasteConf: function pasteConf(index) {
      if (this.copy) {
    ...
    getDevices: function getDevices(search) {
      var _this = this;

      this.$axios.get("/mwChecks/devices_search?q=".concat(escape(search))).then(function (res) {
        _this.options = [];

        var _loop = function _loop(i) {
          var added = _this.report.configuration.filter(function (e) {
            return e.hostname == res.data.options[i].code;
          }).length;

          if (!added) {
            _this.options.push(res.data.options[i]);
          }
        };
    ...
    getCommands: function getCommands(search, index) {
      var _this2 = this;

      this.$axios.get("/mwChecks/commands_search?q=".concat(escape(search))).then(function (res) {
        _this2.commandOptions = [];

        var _loop2 = function _loop2(i) {
          var added = _this2.report.configuration[index].commands.filter(function (e) {
            return e == res.data.options[i].code;
          }).length;

          if (!added) {
            _this2.commandOptions.push(res.data.options[i]);
          }
        };
    ...
    addDevice: function addDevice(event) {
      ...
      if (event.type == 'tag') {
        this.$axios.get("/mwChecks/get_devices_by_tag/".concat(escape(event.code))).then(function (res) {
          for (var i in res.data.devices) {
            _this3.report.configuration.push({
              'hostname': res.data.devices[i],
              'commands': []
            });

            _this3.controls.push({
              val: ''
            });
          }
        });
    ...
    addCommand: function addCommand(event, index) {
      var _this4 = this;

      if (event.type == 'tag') {
        this.$axios.get("/mwChecks/get_commands_by_tag/".concat(escape(event.code))).then(function (res) {
          for (var i in res.data.commands) {
            _this4.report.configuration[index].commands.push(res.data.commands[i]);
          }
        });
      } else {
    ...
    removeDevice: function removeDevice(i) {
      this.report.configuration.splice(i, 1);
    },
    removeCommand: function removeCommand(i, j) {

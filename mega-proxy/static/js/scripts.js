...
(function() {
    ...
    let ipAddressCheck =  document.querySelector('.ipAddressCheck')
    if(ipAddressCheck){
        ipAddressCheck.addEventListener('change', function(e) {
            if (/^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.test(this.value)) {  
                ...
                this.nextElementSibling.innerHTML = 'Dirección IP inválida'
                this.setCustomValidity( 'Dirección IP inválida' );
            }
        })
    }
    ...
    function checkpasswords(e) {
        if (password.value == passwordConfirm.value) {  
            ...
            password.nextElementSibling.innerHTML = 'La contraseña y su confirmación no coinciden'
            password.setCustomValidity( 'La contraseña y su confirmación no coinciden' );
        }
    }
